...
const Link = React.forwardRef((props, ref) => {
  ...
  const isExternal =
    typeof href === 'string' &&
    ((href.indexOf('http') === 0 && href.match(hostReg)[0] !== origin) || href.indexOf('mailto:') === 0)

  if (isExternal) {
    if (noLinkStyle) {
      return <a className={className} href={href} ref={ref} {...other} target='_blank' rel='noreferrer' />
    }

    return <MuiLink className={className} href={href} ref={ref} {...other} target='_blank' rel='noreferrer' />
  }
